...
function playVigas() {
    eventsBottom();
    let pencil = new Draw(canvas, context);
    pencil.reDraw();
    pencil.allEvents();
    ...
    function eventsBottom() {
        ...
        document.getElementById("calcular-armadura").addEventListener("click", e => {
            ...
            let momentos = pencil.calcMomento(pencilMomento);
        ...
        document.getElementById("calc").addEventListener("click", e => {
            ...
            console.log(pencilCis)
            pencil.diagCisa(pencilCis)
            // pencilCis.diagCisa();
        ...
        document.getElementById("calc-momento").addEventListener("click", e => {
            ...
            console.log(pencilMomento)
            pencil.calcMomento(pencilMomento);
